...
| DEC-117 | 11/08/2026 | **Assiette du taux de respect des délais** | Le dénominateur retient les lignes **jugeables** : celles dont la date annoncée est passée, **plus** celles déjà mises en ligne même si leur date est encore à venir. Le numérateur retient les lignes mises en ligne **au plus tard le jour annoncé**. Les lignes annulées sont exclues des deux. | Le §10 dit « lignes échues » sans trancher deux cas. Une ligne publiée en avance disparaîtrait du numérateur et du dénominateur à la fois : bien faire ne changerait rien au taux. Une ligne annulée n'est ni un succès ni un échec ; la laisser tirerait le taux vers le bas pour une décision assumée. Les comparaisons se font au **jour** et non à l'instant, sans quoi une publication mise en ligne à 10 h le jour prévu compterait comme un retard. |

| DEC-118 | 11/08/2026 | **Effet d'un report sur le taux de respect** | Un report **ne répare jamais** une échéance manquée. Le taux est calculé sur `LigneCalendrier.dateDiffusionPrevue`, c'est-à-dire la date du calendrier publié ; la nouvelle date annoncée est stockée dans `Retard.prochaineDateDiffusion` et n'écrase pas la première. | Constat de conception plus qu'arbitrage : le code des retards écrivait déjà le report dans une table séparée. Si le taux suivait la date reportée, une structure pourrait rester à 100 % en repoussant indéfiniment. Le report reste visible et suspend les relances (§8.2) — il change le suivi opérationnel, pas la mesure de la performance. |

| DEC-119 | 11/08/2026 | **Mois sans publication prévue dans la courbe** | La courbe d'évolution mensuelle porte `null` — et non 0 — pour un mois où rien n'était attendu ; le tracé enjambe le trou (`connectNulls`). De même, le taux global vaut « — » et non « 0 % » tant qu'aucune ligne n'est jugeable. | Un 0 % dessine un effondrement là où il n'y avait simplement rien à publier, et se lit comme un échec de la structure. L'absence de mesure et la mesure nulle sont deux informations différentes. |

| DEC-120 | 11/08/2026 | **Structure non mesurable dans le classement** | Une structure sans aucune ligne jugeable est **conservée** dans le classement, sans rang, avec la mention « Non mesurable », et renvoyée en fin de liste. | La retirer masquerait une structure qui n'a encore rien publié ; la placer en tête la ferait passer pour la meilleure. |

| DEC-121 | 24/08/2026 | **Gestion des comptes ouverte aux administrateurs** | L'onglet « Utilisateurs » devient accessible aux **administrateurs**, qui n'y voient et n'y modifient que **les points focaux des structures qu'ils supervisent**. Ils ne peuvent attribuer que le rôle « point focal », et ne voient ni leurs pairs ni le super administrateur. | Le §2.3 réservait `pointFocal:gerer` au seul super administrateur, ce que le test de la matrice figeait. Demande explicite du commanditaire le 24/08/2026 : un administrateur doit pouvoir créer et relancer ses propres points focaux sans passer par l'administration centrale. La restriction de périmètre est indispensable, faute de quoi l'ouverture donnerait à tout administrateur les moyens de créer un super administrateur, donc de s'élever lui-même. Elle est écrite en fonction pure (`peutGererCeCompte`, `rolesAttribuables`) et vérifiée aux quatre endroits qui comptent : la liste affichée, l'enregistrement, la désactivation et le renvoi d'invitation. |
